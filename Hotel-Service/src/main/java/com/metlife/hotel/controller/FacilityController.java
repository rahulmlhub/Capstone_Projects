...
import com.metlife.hotel.service.FacilityService;
...
public class FacilityController {
    ...
    public ResponseEntity<String> deleteFacilityById(@PathVariable String facilityId) {
        ...
        return ResponseEntity.ok("Facility Deleted Successfully with Id:"+facilityId);
    }
}
